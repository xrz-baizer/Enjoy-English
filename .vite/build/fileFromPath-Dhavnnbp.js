...
import { F as File } from './main-Ce_zJykm.js';
export { m as isFile } from './main-Ce_zJykm.js';
...
class FileFromPath {
    ...
    async *stream() {
        ...
        if (mtimeMs > this.lastModified) {
            throw new nodeDomexceptionExports(MESSAGE, "NotReadableError");
        }
        if (this.size) {
...
export { fileFromPath };
//# sourceMappingURL=fileFromPath-Dhavnnbp.js.map
